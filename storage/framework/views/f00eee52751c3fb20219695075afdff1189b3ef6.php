                ...
                <div class="panel-body top-buffer">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <select id="hochschule" class="form-control" name="hochschule" value="<?php echo e(old('hochschule')); ?>" required autofocus>
                                    <?php $__currentLoopData = $hs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option><?php echo e($h->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php if($errors->has('hochschule')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('hochschule')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div>
