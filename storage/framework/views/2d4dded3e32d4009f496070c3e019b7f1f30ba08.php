                ...
                <table class="table">
                    ...
                    <?php $__currentLoopData = $hs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <form action="/hochschule/<?php echo e($h->id); ?>">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $v; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td id="column"> <?php echo e($h->name); ?></td>
                            <td id="column" class="notmobile"> <?php echo e($h->professor); ?></td>
                            <td id="column"> <?php echo e($h->ranking); ?></td>
                            <td>
                                <form action="/hochschule/<?php echo e($h->hid); ?>">
